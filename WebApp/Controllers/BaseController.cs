        ...
        protected override void OnActionExecuting(ActionExecutingContext filterContext)
        {
            ...
            if (Request.Cookies["sessionId"] != null)
            {
                ...
                if (obj != null)
                {
                    ...
                    var currentAction = actionInfoService.LoadEntitie(a => a.Url == requestUrl && a.HttpMethod == requestHttpMethod).FirstOrDefault();//根据URL地址与请求方式找出具体的权限.
                    ...
                    //通过1号线进行校验.
                    var currentUserInfo = userInfoService.LoadEntitie(u => u.ID == LoginUser.ID).FirstOrDefault();//登录用户
