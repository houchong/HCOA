...
namespace LuceneNetDemo
{
    public partial class Form1 : Form
    {
        ...
        {
            string indexPath = @"E:\WorkItem\HCOA\lucenedir";//注意和磁盘上文件夹的大小写一致，否则会报错。将创建的分词内容放在该目录下。
            ...
            for (int i = 1; i <= 10; i++)
            {
                string txt = File.ReadAllText(@"E:\WorkItem\HCOA\test\" + i + ".txt", System.Text.Encoding.Default);//注意这个地方的编码
        ...
        {
            string indexPath = @"E:\WorkItem\HCOA\lucenedir";
            string kw = "万维钢";
        ...
        {
            Thread thread = new Thread(ConsoleNum);
